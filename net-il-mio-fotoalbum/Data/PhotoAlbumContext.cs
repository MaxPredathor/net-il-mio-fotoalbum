...
namespace net_il_mio_fotoalbum.Data
{
    public class PhotoAlbumContext : IdentityDbContext<IdentityUser>
    {
        ...
        {
            base.OnModelCreating(modelBuilder); // Chiamata alla classe parent del OnModelCreating --> Senza da errore perché non fa le operazioni di default per generare il DbContextData
